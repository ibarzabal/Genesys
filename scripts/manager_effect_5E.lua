...
--	EffectManager.setCustomOnEffectAddIgnoreCheck(onEffectAddIgnoreCheck);  GENESYS: Causes issues with text parse.
-- I will have to clean up and remove this script later....
