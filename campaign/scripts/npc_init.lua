...
function onInit_()
	...
	Debug.console("npc_init.lua: inInit");
	...
	if skillsnode then
		...
		if skillautocreated.getValue() ~= 1 then
			Debug.console("npc_init.lua: Skills haven't been created - creating...");
			for k,v in pairs(DataCommon.basicskilldata) do
				...
				skillnode.createChild("skillcheck","number").setValue(0);
			end
			skillsnode.getChild("..skillsautogenerated").setValue(1);
		else
			Debug.console("npc_init.lua: Skills already created.");
		end
	end
