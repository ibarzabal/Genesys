...
function update()
	...
	if updateControl("source", bReadOnly, true) then bSection3 = true; end
	if updateControl("source_page", bReadOnly, true) then bSection3 = true; end
...
function updateDieHeader()
	...
	sDice = StringManager.convertDiceToString(aDice, nMod);
