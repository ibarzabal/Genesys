...
--	castlabel.setVisible(bShowCast);
	castbutton.setVisible(bShowCast);
	skill.setVisible(bShowCast);
	label_plus.setVisible(bShowCast);
	DifficultyMod.setVisible(bShowCast);
	range.setVisible(bShowCast);
	range.setReadOnly(false);
	range_label.setVisible(bShowCast);
